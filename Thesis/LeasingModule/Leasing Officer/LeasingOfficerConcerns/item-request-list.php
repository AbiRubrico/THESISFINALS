	...
	<br>
		<div class="col-md-12">
			<div class="content-panel">
				<h4><i class = "fa fa-angle-right"></i> Item Requests List</h4>
				<hr>
				...
				<div class="container container-fluid">
					<div class = "row">
						<div class="col-lg-11">
							...
							<div class="table">
								<form class="form-horizontal style-form" action="accept-decline-request.php" method="POST">
									<table class="table">
										<thead>
											<tr>
											...
											<?php
												...
												if($queryResult > 0){
													while($row = mysqli_fetch_assoc($result)){
														...
														echo "</td>";
														echo "<td>";
														echo "<a id='btnShowModa1' class='decline' name='decline' title='Decline' data-toggle='tooltip'><i class='material-icons'>&#xe14c;</i></a><a id='btnShowModal1' class='accept' name='accept' title='Accept' data-toggle='tooltip'><i class='material-icons'>&#xe5ca;</i></a>";
														echo "</td>";
														echo "</tr>";
													}
												}
