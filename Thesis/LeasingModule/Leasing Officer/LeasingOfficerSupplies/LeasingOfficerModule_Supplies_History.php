                        ...
                        <table class="table table-stripped table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="#"> </a></td>
                                    <td><a href="#"> </a></td>
                                    <td><a id="btnShowModal1" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xe146;</i></a><a id="btnShowModal1" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xe909;</i></a></td>
                                    <td><a href="#"> </a></td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="Item" class="form-control" id="egItem">
                            <label class="brand" for="Brand">Brand:</label>
                            <input type="Brand" class="form-control" id="egBrand">
                            <label class="desc" for="description">Description:</label>
                            <input type="description" class="form-control" id="egDesc">
                            <label class="price" for="Price">Price:</label>
                            <input type="Price" class="form-control" id="egPrice">
                            <label class="quant" for="quantity">Quantity:</label>
                            <input type="quantity" class="form-control" id="egQuantity">
                        </div>
                    </div>
