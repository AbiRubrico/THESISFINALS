          ...
          <section class="wrapper">
              ...
              <div class="container">
                  ...
                  <div class="pull-right">
                      <button id="btnShowModal" type="button" class="btn btn-info add-new" data-target="#LoginModal">New Entry</button>
                  </div>
              </div>
              <br>
								...
								<?php
									...
									if($queryResults > 0){
										while($row = mysqli_fetch_assoc($results)){
											...
											echo "<td>";
											echo "<input type='button' value='-' id='moins' onclick='minus()'>";
											echo "<input type='text' size='1' value=".$row['quantity'].">";
											echo "<input type='button' value='+' id='plus' onclick='plus()'>";
											echo "</td>";
											echo "</tr>";
										}
									}
        ...
        <div class="modal fade" id="LoginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
					...
					<form class="form-horizontal style-form" action="add-entry-action.php" method="POST">
						...
						<div class="modal-footer text-center">
							<button type="submit" name = "add" class="btn btn-success">Add Entry</button>
						</div>
					</form>
                </div>
            </div>
